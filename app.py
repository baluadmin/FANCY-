...
# Compact header navigation columns pushed to the right using an empty spacer column first
top_space, top_c1, top_c2, top_c3 = st.columns([2.2, 1.0, 1.0, 1.0], gap="small")
with top_space:
